...
class Regressor(nn.Module):
    def __init__(self, feat_dim, smpl_mean_params):
        ...
        self.smpl = SMPL('/data/yangxueting/ICON_orl/data/smpl_related/models/smpl', batch_size=64, create_transl=False)

        mean_params = np.load('/data/yangxueting/ICON_orl/data/HPS/pymaf_data/smpl_mean_params.npz')
